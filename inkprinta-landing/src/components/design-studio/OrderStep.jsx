          ...
          >
            <div className="w-full p-6 flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                {/* Product Design Thumbnail with skeleton loader */}
                <div className="relative w-36 h-36 border-[0.5px] border-cyan-400 rounded-2xl flex items-center justify-center select-none flex-shrink-0 overflow-hidden shadow-sm bg-slate-100">
                  {/* Shimmer skeleton shown until image loads */}
                  <div
                    id="product-img-skeleton"
                    className="absolute inset-0 bg-gradient-to-r from-slate-100 via-slate-200 to-slate-100 animate-pulse rounded-2xl z-10"
                    style={{ display: 'block' }}
                  />
                  <img
                    ...
                    onLoad={(e) => {
                      const skeleton = e.currentTarget.parentElement?.querySelector('#product-img-skeleton');
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <select
                        ...
                        className="h-10 pr-8 pl-3 bg-slate-50 hover:bg-slate-100/75 border border-slate-200 hover:border-slate-300 text-xs font-bold text-slate-700 rounded-xl outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 focus:shadow-[0_0_15px_rgba(6,182,212,0.1)] transition-all cursor-pointer w-full"
                      >
        ...
        <div className="lg:col-span-4 flex flex-col gap-6 sticky top-24">
          ...
          >
            <div className="w-full p-6 flex flex-col gap-4">
              ...
              {submitError && (
                <div className="mt-3 p-3 bg-rose-50 border border-rose-100 rounded-xl text-[10px] font-bold text-rose-600 leading-normal flex items-start gap-2 shadow-[0_2px_8px_rgba(244,63,94,0.04)]" triggerClassName="px-3.5 py-2 bg-white/40 border border-white/60 rounded-xl text-xs font-bold text-slate-700 focus:outline-none cursor-pointer min-w-[160px] max-w-[200px] shadow-sm hover:border-white hover:bg-white/60 transition-all flex items-center justify-between gap-2 h-9 whitespace-nowrap overflow-hidden">
